...
class ExpenseCategoryController {
    ...
    public function index() {
        ...
        require_once 'views/expense/categories.php';
    }
    
    public function create() {
        // Load create category view
        require_once 'views/expense/category_create.php';
    }
    
    public function store() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: index.php?page=expense/categories');
            exit;
        }
        ...
        if (empty($name)) {
            ...
            header('Location: index.php?page=expense/category/create');
            exit;
        }
